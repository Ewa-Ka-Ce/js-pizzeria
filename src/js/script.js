...
//const {render} = require('node-sass');
{
  ...
  class Product {
    ...
    initAccordion() {
      ...
      /* START: add event liostener to clickable trigger on event click*/
      thisProduct.accordionTrigger.addEventListener('click', function (event) {
        /*prevent default action for event */
        event.preventDefault();
        /* find active product (product has an active class) */
    ...
    processOrder() {
      ...
      thisProduct.processOrder.Single = price;
  ...
  class Cart {
    ...
    update() {
      ...
      thisCart.totalNumber === 0 ? thisCart.deliveryFee = 0 : thisCart.totalPrice = thisCart.deliveryFee + thisCart.subTotalPrice;
